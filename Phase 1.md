...
5. Implement and audit the causal micro-event compiler, currently `phase1-causal-v15`, including strict temporal cutoffs, raw-evidence verification, and a compact model-facing WRITE destination derived from pre-mutation Accessibility evidence.
