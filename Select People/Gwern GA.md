...
The continual learning problem of catastrophic forgetting is largely solved by a small amount of replay and overparameterized models. Larger models are increasingly sample-efficient and robust to catastrophic forgetting, as they have plenty of model capacity to store increasingly orthogonal datapoints in (cf. ‘overtraining’ past Chinchilla-optimal); see [Scialom et al 2022](https://arxiv.org/abs/2205.12393), [Dohare et al 2023](https://arxiv.org/abs/2306.13812), [Ibrahim et al 2024](https://arxiv.org/abs/2403.08763).
