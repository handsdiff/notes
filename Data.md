...
#### more formal notes
- wait DELAY (perhaps 3) seconds after a keyboard entry or mouse movement or mouse scroll, then take a SNAPSHOT
...
- collection surfaces will be informed by actual implementation, but likely covers codex app, browser use
- 
