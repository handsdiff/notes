...
algorithms considered and rejected for now and why: (there are likely practicalities that result in other algorithms perhaps being superior, this is a non practitioner's pre-experiment take)
	...
	- https://jacobxli.com/blog/2026/machine-studying/ seems very relevant to continual learning, possibly good benchmark
		...
		- they mention synthetic data as another main axis, which i gained intuition for from the paper that generates Q/A pairs from the corpus for studying (not sure where that is anymore), 
