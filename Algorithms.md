...
algorithms considered and rejected for now and why: (there are likely practicalities that result in other algorithms perhaps being superior, this is a non practitioner's pre-experiment take)
	...
	- [[Google Pi Team]]
		...
		- https://arxiv.org/pdf/2602.16301 MUPI toy example
			...
			- apparently the training in-context approximates the ability to learn the scenario you're in based on the history and act best according to your prior of the situation. https://openreview.net/attachment?id=W1Ta00wVlK&name=pdf
