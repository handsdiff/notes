algorithms considered and rejected for now and why: (there are likely practicalities that result in other algorithms perhaps being superior, this is a non practitioner's pre-experiment take)
	...
	- will brown phd https://willcb.com/blog/feedback-loops/ https://scholar.google.com/citations?user=JUJdJMoAAAAJ
		...
		- one thing that stands out is that they DO model how prior recommendations influence future choices, which i had not seen before. the implication is that optimal recommendations are path dependent
