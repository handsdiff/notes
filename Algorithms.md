...
- with the BC -> IPO pipeline, there would be an inferred reward, although its context dependent. also we would want to keep in mind how the data will immediately shift after suggestions start, since they will now be part of the history. this likely has implications i am not fully grokking. i think this is what coactive learning is meant to handle.