...
- https://x.com/dianetc_/status/2089685743018885444?s=20
- i wonder if learning thinking is cooked because its a high entropy activity rather than a low entropy activity that needs to be automated
- the diff now is that models are theoretically way better when compared to 2024