...
**For every \$1 spent on tokens reading context, ~\$13 of human time went into producing it.** Businesses pay people to gather information, decide what matters, translate it into prompts, and correct work produced without it. The value of this wasted time is on track to hit **$1T by next year**, doubling every 2 years. [Appendix]
