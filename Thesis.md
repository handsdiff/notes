...
However, search-based retrieval is insufficient. Two people can observe the same information and take different actions because context does not contain the decision rule that converts information into judgment. As agents increasingly persist, accrue assets and, more importantly, initiate liabilities on our behalf, they need a model that can genuinely simulate how *you* would respond to a given situation, or they cannot be trusted.
