...
Context is a trillion dollar cost doubling every 18 months. For every $1 spent on tokens that read context, $16 of human time went into producing it. As raw intelligence increases exponentially, and the cost decreases ecpon
